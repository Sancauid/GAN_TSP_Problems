...
for i in range(len(train_data)):
    print(i)
    img_path = f'data/imgs/tsp_solution.28.{i}.png'
...
print("RESULTADOS SET DE ENTRENAMIENTO TSP CON SOLUCIÓN:\n")
...
for i in range(len(test_data)):
    img_path = f'data/imgs/tsp_solution.28.{split_index2 + i}.png'
    img = keras.preprocessing.image.load_img(img_path, target_size=input_shape[:2])
    img_array = keras.preprocessing.image.img_to_array(img)
    img_array = tf.expand_dims(img_array, 0)
...
print("RESULTADOS SET DE TESTEO TSP CON SOLUCIÓN:\n")
